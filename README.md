...
**NOTE: This project is modified from [the original project](https://github.com/jepsen-io/jepsen/tree/main/docker).**
...
Assuming you have docker-compose set up already,

**make sure you have set environment variable `$JEPSEN_WORK_DIR` for your jepsen test project path**, and run:
...
... which will drop you into a console on the Jepsen control node. **Your project will be mounted at `/home/Work`.**
